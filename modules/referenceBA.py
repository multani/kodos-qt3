...
#
# Created: Thu Dec 4 20:08:37 2003
...
"#b#...#aaa##.#bbb##.#b#aaa#.....",
"#bb#...#aaa#f.###.fghb#aa#....##",
"#bbb#..#aaa#hg.i.fhhjb#aa#...#b#",
".#bbb#.#aaa#jhgkf#jlj#aaa#...#b#",
"..#bb#.#aa##ll###bhhl#aaa#..#bb#",
"..#bb#####bbhjbbbbhlh#aaa#..#bb#",
"..###bbbbb#bbj###bhjbb#aa#..#bb#",
"..#bbbb#bb#bbbbbbbbbbbb##...#bb#",
"..#bb###bb#############mm###bbb#",
".#bb#.#bb#mmmmmmmmmmmmmmm#bbbb#.",
".###..########################.."
]
image1_data = [
"22 22 7 1",
...
class ReferenceBA(QMainWindow):
    def __init__(self,parent = None,name = None,fl = 0):
        ...
        self.editFindAction.setIconSet(QIconSet(image10))
        self.helpContentsAction = QAction(self,"helpContentsAction")
        self.helpIndexAction = QAction(self,"helpIndexAction")
        self.helpAboutAction = QAction(self,"helpAboutAction")
        self.helpAction = QAction(self,"helpAction")
        self.helpAction.setIconSet(QIconSet(image11))
    ...
    def languageChange(self):
        self.setCaption(self.tr("Kodos - Regex Reference Guide"))
        self.referenceListView.header().setLabel(0,self.tr("Symbol"))
        self.referenceListView.header().setLabel(1,self.tr("Definition"))
        ...
        self.editPasteAction.setToolTip(self.tr("Paste selection into Kodos"))
        ...
        self.helpAction.setText(self.tr("Help"))
        self.helpAction.setMenuText(self.tr("&Help"))
        self.helpPythonAction.setText(self.tr("Python Regex Help"))
        self.helpPythonAction.setMenuText(self.tr("&Python Regex Help"))
